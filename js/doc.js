...
function check_data_send() {
    ...
    return [op_c, organismo, tipo_documento, fecha_oficio, fecha_recibido, remitente, cargo_r, op_control, otro, anexos, comentarios, n_oficio, direccion_cat,file];
...
function validate_data() {
    ...
    console.log(op_c, organismo, tipo_documento, fecha_oficio, fecha_recibido, remitente, cargo_r, op_control, otro, anexos, comentarios, n_oficio, direccion_cat, file);



    if (op_c == 0 || organismo == 0 || tipo_documento == 0 || fecha_oficio == '' ||
        fecha_recibido == '' || remitente == '' || cargo_r == '' || op_control == '' || direccion_cat == 0 || file == '') {
