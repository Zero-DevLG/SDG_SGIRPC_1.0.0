...
include("../Model/Conexion.php");
    ...
    //Se obtienen los datos de los participantes en base al id de direccion
    $sql = $pdo->prepare("SELECT titular,cargo FROM equipo_registro WHERE id_direccion = '$direccion'");
    $sql->execute();
    $datos_participante = $sql->fetchAll(PDO::FETCH_ASSOC);
    foreach($datos_participante as $get)
    {
        $titular = $get['titular'];
        $cargo = $get['cargo'];
    }
    ...
    $sentencia_ia->bindParam(':p_nombre', $titular);
