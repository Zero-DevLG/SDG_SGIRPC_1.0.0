<head>
    <link rel="stylesheet" href="../css/as_ins.css">
</head>
<body>
    ...
    <div id="data">
        ...
        ?>
            ...
            <div id="menu_participantes">
                    <input type="hidden" name="txtid_documento" id="txtid_documento" value="<?php echo $id_documento; ?> ">
                    <div id="part"></div>
            </div>
            <div id="menu_datos">
                <div id="options">
                    <button class="btn btn-sm btn-primary button-options" id="select-p"><img src="../img/iconos/pa.png" alt="Añadir participantes" title="Añadir participantes"></button>
                </div>
...
<div class="modal fade" id="parti" tabindex="2" role="dialog">
